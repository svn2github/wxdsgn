...
uses WinTypes, WinProcs, Messages, SysUtils, Classes, Controls,
  Forms, Graphics, ComCtrls, ExtCtrls, WxUtils, WxSizerPanel, TreePageControl, wxAuiToolBar, wxAuiNoteBookPage;
...
function TWxTreebook.GetIDValue: integer;
begin
  Result := wx_IDValue;
end;
...
procedure TWxTreebook.SetIDValue(IDValue: integer);
begin
  Wx_IDValue := IDVAlue;
end;
