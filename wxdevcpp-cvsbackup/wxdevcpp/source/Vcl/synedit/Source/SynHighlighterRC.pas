...
uses
 sysUtils, Classes, Windows, Controls, Graphics, SynEditTypes, SynEditHighlighter;
...
{$IFNDEF SYN_CPPB_1} class {$ENDIF}
function TSynRCSyn.GetCapabilities: TSynHighlighterCapabilities;
begin
  result:= inherited GetCapabilities;
end;

{$IFNDEF SYN_CPPB_1} class {$ENDIF}
function TSynRCSyn.GetLanguageName: string;
begin
  result:= SYNS_LangRC;
end;
