...
//  inherited;
  ...
  end else if (Key >= SYNEDIT_F1) and (key <= SYNEDIT_F24) then
  begin
    TmpString := TmpString + 'F' + IntToStr(Key - SYNEDIT_F1 + 1);
  end
  else
  begin
    Case Key of
      SYNEDIT_UP        : TmpString := TmpString + 'Up';
      SYNEDIT_DOWN      : TmpString := TmpString + 'Down';
      SYNEDIT_LEFT      : TmpString := TmpString + 'Left';
      SYNEDIT_RIGHT     : TmpString := TmpString + 'Right';
      SYNEDIT_SPACE     : TmpString := TmpString + 'Space';
      SYNEDIT_PRIOR     : TmpString := TmpString + 'Page Up';
      SYNEDIT_NEXT      : TmpString := TmpString + 'Page Down';
      SYNEDIT_END       : TmpString := TmpString + 'End';
      SYNEDIT_HOME      : TmpString := TmpString + 'Home';
      SYNEDIT_PRINT     : TmpString := TmpString + 'Print Screen';
      SYNEDIT_INSERT    : TmpString := TmpString + 'Insert';
      SYNEDIT_DELETE    : TmpString := TmpString + 'Del';
      SYNEDIT_NUMPAD0   : TmpString := TmpString + 'Numpad 0';
      SYNEDIT_NUMPAD1   : TmpString := TmpString + 'Numpad 1';
      SYNEDIT_NUMPAD2   : TmpString := TmpString + 'Numpad 2';
      SYNEDIT_NUMPAD3   : TmpString := TmpString + 'Numpad 3';
      SYNEDIT_NUMPAD4   : TmpString := TmpString + 'Numpad 4';
      SYNEDIT_NUMPAD5   : TmpString := TmpString + 'Numpad 5';
      SYNEDIT_NUMPAD6   : TmpString := TmpString + 'Numpad 6';
      SYNEDIT_NUMPAD7   : TmpString := TmpString + 'Numpad 7';
      SYNEDIT_NUMPAD8   : TmpString := TmpString + 'Numpad 8';
      SYNEDIT_NUMPAD9   : TmpString := TmpString + 'Numpad 9';
      SYNEDIT_MULTIPLY  : TmpString := TmpString + 'Multiply';
      SYNEDIT_ADD       : TmpString := TmpString + 'Add';
      SYNEDIT_SEPARATOR : TmpString := TmpString + 'Separator';
      SYNEDIT_SUBTRACT  : TmpString := TmpString + 'Subtract';
      SYNEDIT_DECIMAL   : TmpString := TmpString + 'Decimal';
      SYNEDIT_DIVIDE    : TmpString := TmpString + 'Divide';
      SYNEDIT_NUMLOCK   : TmpString := TmpString + 'Num Lock';
      SYNEDIT_SCROLL    : TmpString := TmpString + 'Scroll Lock';
      SYNEDIT_BACK      : TmpString := TmpString + 'Backspace';
      SYNEDIT_TAB       : TmpString := TmpString + 'Tab';
      SYNEDIT_CLEAR     : TmpString := TmpString + 'Clear';
      SYNEDIT_RETURN    : TmpString := TmpString + 'Return';
      SYNEDIT_PAUSE     : TmpString := TmpString + 'Pause';
      SYNEDIT_CAPITAL   : TmpString := TmpString + 'Caps Lock';
    else
