...
{         [+] Added new event "OnPropModified"          }
{                                                       }
...
uses
    Classes, Controls, Grids, Graphics, Types, Windows,
    Messages, Forms, StdCtrls, ELControls, SysUtils, Dialogs, TypInfo
    , Variants, ComCtrls, Menus, ELSConsts
...
type
    ...
    TELPropertyInspectorOnPropModified = procedure(Sender: TObject;
        AInstance: TPersistent; AEditor: TELPropEditor) of object;
    ...
    private
        ...
        FOnGetComponentNames: TELOnGetComponentNames;
        FOnModified: TNotifyEvent;
        FOnPropModified: TELPropertyInspectorOnPropModified;
        FOnGetComponentName: TELOnGetComponentName;
    ...
    protected
        ...
        property OnModified: TNotifyEvent read FOnModified write FOnModified;
        property OnPropModified: TELPropertyInspectorOnPropModified read FOnPropModified write FOnPropModified;
    ...
    public
        ...
        procedure InternalModified;  // @mh (moved from private)
        procedure InternalPropModified(Editor: TELPropEditor);
        procedure Modified;
...
begin
    TELCustomPropertyInspector(Owner).InternalPropModified(FEditor);
...
procedure TELCustomPropertyInspector.InternalPropModified(Editor: TELPropEditor);  // @mh
begin
    if Assigned(OnPropModified) then
        OnPropModified(Self, Editor.GetInstance(0), Editor);
end;
