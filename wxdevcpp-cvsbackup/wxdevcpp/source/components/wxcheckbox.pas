...
{                                                                    }
{   Generated from source file e:\backup\delphi\demo\wxdevcpp\source\compon~1\compcode\wxchec~1.cd }
{   on 26 Sept 2004 at 23:48                                         }
{                                                                    }
...
type
  TWxCheckBox = class(TCheckBox,IWxComponentInterface)
    private
...
begin
    ...
    Result:=Format('%s =  new %s(%s, %s, _("%s") , wxPoint(%d,%d),wxSize(%d,%d) %s);',[self.Name,wx_Class,parentName,GetWxIDString(self.Wx_IDName,self.Wx_IDValue),self.Text,self.Left,self.Top,self.width,self.Height,strStyle] );
