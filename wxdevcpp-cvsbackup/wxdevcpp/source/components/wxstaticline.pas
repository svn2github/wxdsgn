...
type
  ...
  published
    ...
    property Wx_LIOrientation: TWx_LIOrientation
      Read FWx_LIOrientation Write FWx_LIOrientation;

    property Wx_Length: integer Read FWx_Length Write FWx_Length;
    property LastOrientation: TWx_LIOrientation
      Read FLastOrientation Write FLastOrientation;
  end;
