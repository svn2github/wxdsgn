...
type
  ...
  TWxSizerVerticalAlignment = (wxSZALIGN_TOP, wxSZALIGN_BOTTOM,
    wxSZALIGN_CENTER_VERTICAL, wxSZALIGN_GROW_VERTICAL);
  TWxSizerHorizontalAlignment = (wxSZALIGN_LEFT, wxSZALIGN_RIGHT,
    wxSZALIGN_CENTER_HORIZONTAL, wxSZALIGN_GROW_HORIZONTAL);
...
function GetSpinButtonSpecificStyle(stdstyle: TWxStdStyleSet;
  sbtnstyle: TWxsbtnStyleSet): string;
...
function GetListViewSpecificStyle(stdstyle: TWxStdStyleSet;
  lstvwstyle: TWxLVStyleSet): string;
...
function GetcomboBoxSpecificStyle(stdstyle: TWxStdStyleSet;
  cmbstyle: TWxCmbStyleSet): string;
...
function SizerAlignmentToStr(SizerVerticalAlignment: TWxSizerVerticalAlignment): string;
  overload;
function SizerAlignmentToStr(SizerHorizontalAlignment:
  TWxSizerHorizontalAlignment): string;
  overload;
...
begin
  ...
  Constraints.MinHeight := (ClientHeight - mm.ClientHeight) + 43 +
    (Height - ClientHeight);
end;
