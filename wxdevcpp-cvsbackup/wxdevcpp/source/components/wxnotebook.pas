...
type
  TWxNotebook = class(TPageControl,IWxComponentInterface,IWxContainerInterface,IWxContainerAndSizerInterface,IWxWindowInterface)
    private
    ...
    published
        ...
        property Wx_NoteBookStyle :  TWxnbxStyleSet read FWx_NoteBookStyle write FWx_NoteBookStyle; 
        ...
        property EVT_NOTEBOOK_PAGE_CHANGING  : string read FEVT_NOTEBOOK_PAGE_CHANGING write FEVT_NOTEBOOK_PAGE_CHANGING;
...
begin
     ...
     begin
          Result:=Result+#13+Format('EVT_NOTEBOOK_PAGE_CHANGED(%s,%s::%s)',[WX_IDName,CurrClassName,EVT_NOTEBOOK_PAGE_CHANGED]) +'';
     end;

     if trim(EVT_NOTEBOOK_PAGE_CHANGING) <> '' then
     begin
          Result:=Result+#13+Format('EVT_NOTEBOOK_PAGE_CHANGING(%s,%s::%s)',[WX_IDName,CurrClassName,EVT_NOTEBOOK_PAGE_CHANGING]) +'';
     end;
